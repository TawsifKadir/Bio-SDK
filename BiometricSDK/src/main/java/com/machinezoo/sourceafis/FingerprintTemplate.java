...
public class FingerprintTemplate {
	 ...
	 * @see #FingerprintTemplate(FingerprintImage)
	 */
	public FingerprintTemplate create(byte[] image,int width,int height) {
		immutable = new ImmutableTemplate(FeatureExtractor.extract(new FingerprintImage().decode(image,width,height).matrix, dpi));
		return this;
	}
