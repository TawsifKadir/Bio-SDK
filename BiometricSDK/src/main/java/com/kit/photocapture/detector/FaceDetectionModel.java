...
public class FaceDetectionModel {
    ...
    public static final float DEFAULT_SCORE_THRESHOLD = 0.4f;
    public static final float DEFAULT_NMS_THRESHOLD = 0.3f;
    public static final int DEFAULT_TOP_K = 5000;
    public static final Size DEFAULT_INPUT_SIZE = new Size(480, 480);
