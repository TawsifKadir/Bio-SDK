...
public class FingerprintCompatibility {
	...
	///Faisal CHange
	private static String version = "1.0"; ///BuildConfig.VERSION_NAME;
	/**
	...
	public static List<FingerprintTemplate> convertAll(byte[] template) {
		Objects.requireNonNull(template);
		try {
			com.localafis.fingerprintio.TemplateFormat format = com.localafis.fingerprintio.TemplateFormat.detect(template);
	...
	private static byte[] encode(com.localafis.fingerprintio.TemplateFormat format, FingerprintTemplate[] templates) {
	...
	public static byte[] toAnsiIncits378v2004(FingerprintTemplate... templates) {
		return encode(com.localafis.fingerprintio.TemplateFormat.ANSI_378, templates);
	}
	/**
	...
	public static byte[] toAnsiIncits378v2009(FingerprintTemplate... templates) {
		return encode(com.localafis.fingerprintio.TemplateFormat.ANSI_378_2009, templates);
	}
	/**
