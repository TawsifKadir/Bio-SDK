...
import com.localafis.fingerprintio.common.TemplateFormatException;
...
public class Ansi378v2009Template {
	...
	private int measure() {
		// src: return 21 + fingerprints.stream().mapToInt(Ansi378v2009Fingerprint::measure).sum();
		return 21 + StreamSupport.stream(fingerprints).mapToInt(Ansi378v2009Fingerprint::measure).sum();
	}
