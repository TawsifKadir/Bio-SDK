...
import com.localafis.fingerprintio.common.BiometricOrganizations;
import com.localafis.fingerprintio.common.BiometricQualityAlgorithms;
import com.localafis.fingerprintio.utils.DataInputBuffer;
import com.localafis.fingerprintio.utils.DataOutputBuffer;
import com.localafis.fingerprintio.utils.TemplateUtils;
...
public class Ansi378v2009Am1Fingerprint {
	...
	Ansi378v2009Am1Fingerprint(DataInputBuffer in, boolean lax) {
		position = com.localafis.fingerprintio.utils.TemplateUtils.decodeType(in.readUnsignedByte(), Ansi378v2009Am1Position.class, lax, "Unrecognized finger position code.");
