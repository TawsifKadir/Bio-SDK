...
public class TemplateUtils {
	...
	public static <T> T decodeType(int code, T[] candidates, java8.util.function.ToIntFunction<T> codes, boolean lax, String message) {
		T type = J8Arrays.stream(candidates).filter(t -> codes.applyAsInt(t) == code).findFirst().orElse(null);
